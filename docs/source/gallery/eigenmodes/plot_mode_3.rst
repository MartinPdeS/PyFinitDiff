...
.. "gallery/eigenmodes/plot_mode_3.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_gallery_eigenmodes_plot_mode_3.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_eigenmodes_plot_mode_3.py:
...
.. image-sg:: /gallery/eigenmodes/images/sphx_glr_plot_mode_3_001.png
   :alt: eigenvalues:  1.4+0.0j, eigenvalues:  1.4+0.0j, eigenvalues:  1.3+0.0j, eigenvalues:  1.3+0.0j, eigenvalues:  1.3+0.0j
   :srcset: /gallery/eigenmodes/images/sphx_glr_plot_mode_3_001.png
...
.. _sphx_glr_download_gallery_eigenmodes_plot_mode_3.py:
